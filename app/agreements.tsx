...
const ROWS: AgreementRow[] = [
    {
        ...
        subtitle: 'Uygulamayı kullanırken geçerli olan şartlar',
        icon: 'file-text',
    },
    {
        title: 'KVKK Aydınlatma Metni',
        subtitle: 'Kişisel verilerinizin işlenmesine ilişkin bilgilendirme',
        icon: 'shield',
    },
    {
        title: 'Açık Rıza Beyanı',
        subtitle: 'Kişisel verilerinizin işlenmesine ilişkin onayınız',
        icon: 'check-circle',
    },
];
    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-50" edges={['top']}>
            <View className="px-6 pt-4 pb-4 bg-white border-b border-gray-100 flex-row items-center">
                ...
                <Text className="text-gray-900 text-xl font-bold tracking-tight">Kullanım Koşulları ve Gizlilik</Text>
            </View>
